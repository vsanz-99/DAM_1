	...
	public static void main(String[] args) {
		try (Scanner teclado = new Scanner (System.in)) {
			...
			do {
				...
				codigointro = teclado.next();

				if ( codigointro.length() == 8 ) {
					String test1 = codigointro.substring(0, 4);

					if (( test1.equals("1990") ) || ( test1.equals("1991") ) || ( test1.equals("1992") ) || ( test1.equals("1993") ) || ( test1.equals("1994") ) || ( test1.equals("1995") )) {
			...
			System.out.println("\n Hay " + contsecond_h + " mujere/s matriculada/s en segundo.");
